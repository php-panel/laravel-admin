    ...
    <div class="wrap">
        ...
        <div class="select-options">
            <ul>
                ...
                @endphp
                <li>
                    <a href="{{ \Ladmin\Grid\Tools\Selector::url($column, $value, true) }}"
                        class="{{$active ? 'active' : ''}}">{{ $option }}</a>
                    @if(!$active && $selector['type'] == 'many')
                    &nbsp;
                    <a href="{{ \Ladmin\Grid\Tools\Selector::url($column, $value) }}" class="add"><i
                ...
                @endforeach
                <li>
                    <a href="{{ \Ladmin\Grid\Tools\Selector::url($column) }}" class="clear"><i
